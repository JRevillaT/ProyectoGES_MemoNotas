...
import com.redsystem.agendaonline.IA.Reconocimiento_de_Texto;
...
public class MenuPrincipal extends AppCompatActivity {
    ...
    Button AgregarNotas, ListarNotas, Importantes,Contactos,IA,CerrarSesion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IA = findViewById(R.id.ia_reconocimiento);
    ...
    private void ReconociemtoDeTexto() {
        startActivity(new Intent(MenuPrincipal.this, Reconocimiento_de_Texto.class));
